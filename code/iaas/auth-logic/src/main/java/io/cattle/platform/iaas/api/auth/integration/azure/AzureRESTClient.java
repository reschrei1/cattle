...
public class AzureRESTClient extends AzureConfigurable{
    ...
    public String getAccessToken(String code) {
        ...
        try{   
           ...
           logger.info("client_id: " + URLEncoder.encode(AzureConstants.AZURE_CLIENT_ID.get(), "UTF-8"));
           logger.info("username: " + URLEncoder.encode(username, "UTF-8"));
           logger.info("password: " + URLEncoder.encode(split[1], "UTF-8"));
           logger.info("url: " + AzureConstants.AUTHORITY);
